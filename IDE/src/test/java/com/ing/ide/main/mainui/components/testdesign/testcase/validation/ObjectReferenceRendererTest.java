...
public class ObjectReferenceRendererTest {
    ...
    public void testValidationResult_Valid() {
        ObjectReferenceRenderer.ValidationResult result = 
            ObjectReferenceRenderer.ValidationResult.valid();
    ...
    public void testValidationResult_Violation() {
        ObjectReferenceRenderer.ValidationResult result = 
            ObjectReferenceRenderer.ValidationResult.violation(
                Color.RED, "Test violation", 1
            );
    ...
    public void testValidateObjectReferences_NullScope_NoValidation() {
        ...
        ObjectReferenceRenderer.ValidationResult result = 
            ObjectReferenceRenderer.validateObjectReferences(
    ...
    public void testValidateObjectScope_ProjectReusableProjectObject() {
        ObjectReferenceRenderer.ValidationResult result = 
            ObjectReferenceRenderer.validateObjectScope(
                "LoginButton",
                ORScope.PROJECT,
    ...
    public void testValidationResult_SingleViolationCount() {
        ObjectReferenceRenderer.ValidationResult result = 
            ObjectReferenceRenderer.ValidationResult.violation(Color.RED, "Violation", 1);
    ...
    public void testValidationResult_MultipleViolationCount() {
        ObjectReferenceRenderer.ValidationResult result = 
            ObjectReferenceRenderer.ValidationResult.violation(Color.RED, "Violations", 3);
