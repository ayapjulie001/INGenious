...
public class DataAccessScopeTest {
    ...
    public void setUp() {
        ...
        when(mockProjectReusableContext.getResolvedReusableScope()).thenReturn(ReusableRef.Scope.PROJECT);
        ...
        when(mockSharedReusableContext.getResolvedReusableScope()).thenReturn(ReusableRef.Scope.SHARED);
    ...
    public void testGetScopeContextString_ProjectReusable() {
        ...
        assertNotNull(scopeContext);
        assertEquals(scopeContext, " (scope: [PROJECT])", "Project reusable should include PROJECT scope");
    }
    ...
    public void testGetScopeContextString_SharedReusable() {
        ...
        assertNotNull(scopeContext);
        assertEquals(scopeContext, " (scope: [SHARED])", "Shared reusable should include SHARED scope");
    }
    ...
    public void testBuildScopeAwareErrorMessage_NonReusable() {
        String result = DataAccessInternal.buildScopeAwareErrorMessage(
            "missing_field", null, "LoginData", "username"
        );
        
        assertEquals(result, "missing_field", 
            "Non-reusable should return info unchanged");
    }
    ...
    public void testBuildScopeAwareErrorMessage_ProjectScope() {
        String result = DataAccessInternal.buildScopeAwareErrorMessage(
            "missing_field", ReusableRef.Scope.PROJECT, "LoginData", "username"
        );
        
        assertEquals(result, "[PROJECT] missing_field", 
    ...
    public void testBuildScopeAwareErrorMessage_SharedScope() {
        String result = DataAccessInternal.buildScopeAwareErrorMessage(
            "missing_field", ReusableRef.Scope.SHARED, "SharedData", "email"
        );
        
        assertEquals(result, "[SHARED] missing_field", 
    ...
    public void testGetIterations_ProjectReusableLogging() {
        ...
        String expectedLogPattern = "Fetching iterations for sheet.*scope.*PROJECT.*SharedLogin:ValidateLogin";
    ...
    public void testGetIterations_SharedReusableLogging() {
        String expectedLogPattern = "Fetching iterations for sheet.*scope.*SHARED.*SharedDataValidation:CheckDataConsistency";
        // Actual logging verification would require a logging framework mock/listener
    ...
    public void testErrorMessage_NonReusable_NoScopePrefix() {
        ...
        String result = DataAccessInternal.buildScopeAwareErrorMessage(
            "field_not_found", null, "TestData", "fieldName"
        );
        
        assertFalse(result.contains("["), 
            "Non-reusable error should not contain scope brackets");
        assertEquals(result, "field_not_found", 
            "Non-reusable error should be unchanged");
    }
    ...
    public void testContextCarrisScopeMetadata_Project() {
        assertNotNull(mockProjectReusableContext.getResolvedReusableScope(), 
            "PROJECT reusable context should have scope");
        assertEquals(mockProjectReusableContext.getResolvedReusableScope(), 
            ReusableRef.Scope.PROJECT, "Should be PROJECT scope");
    }
    ...
    public void testContextCarriesScopeMetadata_Shared() {
        assertNotNull(mockSharedReusableContext.getResolvedReusableScope(), 
            "SHARED reusable context should have scope");
        assertEquals(mockSharedReusableContext.getResolvedReusableScope(), 
            ReusableRef.Scope.SHARED, "Should be SHARED scope");
    }
    ...
    public void testContextCarriesScopeMetadata_None() {
        assertNull(mockContext.getResolvedReusableScope(), 
            "Regular testcase should have no scope");
    }
    ...
    public void testPhase2Phase3Integration_UnScopedFallbackReusable() {
        ...
        assertEquals(mockContext.getResolvedReusableScope(), 
            ReusableRef.Scope.PROJECT,
